				...
				<div className="sidebar-canvas-container">
					<div className="sidebar-canvas-head">
						...
						<div className="sidebar-canvas-lang">
							...
							<a className="close-canvas" onClick={handleOffcanvas}> <img alt="Dynamic-Cars" src="/assets/imgs/template/icons/close.png" /></a>
						</div>
					</div>
					<div className="sidebar-canvas-content">
						<div className="box-author-profile">
							<div className="card-author">
								<div className="card-image"><img src="/assets/imgs/page/homepage1/author2.png" alt="Dynamic-Cars" /></div>
						...
						<div className="box-contactus">
							...
							<div className="contact-info">
								...
								<p className="email-2 text-md-medium neutral-1000">support@Dynamic-Cars.com</p>
							</div>
						</div>
					</div>
				</div>
