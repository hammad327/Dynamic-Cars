	...
	return (
		<>
          ...
          <div className="text-header-info">
              <Link className="phone-head no-hover text-white" href="tel:+441372613001">
              <svg
              width={26}
              height={26}
              viewBox="0 0 16 16"
              ...
              <Link
                ...
                href="mailto:bookings@dynamiccarsuk.co.uk"
              >
                <svg
                  width={26}
                  height={26}
            ...
            <div className="top-right-header">
              ...
              <div className="d-none d-xl-inline-block align-middle mr-15">
                <a
                  href="https://www.facebook.com/Dynamiccarsuk/"
                  target="_blank"
                ...
                <a
                  href="https://twitter.com/dynamiccarsuk"
                  target="_blank"
                  className="social-icon"
                >
                  <i
                ...
                <a
                  href="https://www.instagram.com/dynamiccarsuk/"
                  target="_blank"
                  className="social-icon"
                >
                  <i
                ...
                <a
                  href="https://www.youtube.com/@dynamiccars3169"
                  target="_blank"
                  className="social-icon"
                >
                  <i
						...
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img className="light-mode" alt="Carento" src="/assets/imgs/template/logo-w.png" />
									<img className="dark-mode" alt="Carento" src="/assets/imgs/template/logo-w.svg" />
								</Link>
							</div>
							<div className="header-nav">
								<nav className="nav-main-menu  ml-40">
              ...
              <div className="d-none d-lg-inline-block align-middle mr-15">
                <Link className="btn btn-signin bg-black text-light" href="/contact">
                  Book Now
                </Link>
              </div>
                <div
