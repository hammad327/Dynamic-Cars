...
export default function Header2({ scroll, isMobileMenu, handleMobileMenu, handleOffcanvas, isOffcanvas }: any) {
	return (
		<>
            ...
            <Link className="phone-head text-white" href="tel:+441372613001">
    <svg
      width={16}
      height={16}
      viewBox="0 0 16 16"
    ...
    <span className="d-none d-lg-inline-block">
      +44 13 7261 3001 / +44 20 3488 3484
    </span>
  </Link>
              <Link className="email-head text-white" href="mailto:bookings@dynamiccarsuk.co.uk">
    <svg
      width={16}
      height={12}
      viewBox="0 0 16 12"
