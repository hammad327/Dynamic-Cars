						...
						<div className="container">
							<div className="row pb-50">
								<div className="col-lg-4">
									...
									THE LEADING CAR<br />
									<span className="text-primary" style={{ fontSize: "35px" }}>TRANSPORT <span className="text-black">PROVIDER</span></span>
									</h3>
								</div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-5">
                ...
                <h4 className="mb-4 neutral-1000">
                  Reliable & Professional Car Services <br /> Your Journey Starts Here
                </h4>
